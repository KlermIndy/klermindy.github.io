function calculate() {
    ...
    const districtPrice = parseFloat($('#xAbove').val()) || 0;
    ...
    if (aboveWidth > 0)
    {
        ...
        if (aboveMinusWidth > 0) {
            result += 'ตู้บน (ระยะรวม ' + aboveWidth + ' เมตร หักลบพื้นที่ซ้อนทับ ' + aboveMinusWidth + ' เมตร เหลือ ' + (aboveWidth - aboveMinusWidth) + ' เมตร)';
        }
        else {
            result += 'ตู้บน (ระยะรวม ' + aboveWidth + ' เมตร)';
        }
    ...
    if (belowWidth > 0)
    {
        result += ' <br /> ';
        if (belowMinusWidth > 0) {
            result += 'ตู้ล่างมีสองราคาค่ะ (ระยะรวม ' + belowWidth + ' เมตร หักลบพื้นที่ซ้อนทับ ' + belowMinusWidth + ' เมตร เหลือ ' + (belowWidth - belowMinusWidth) + ' เมตร)';
        }
        else {
            result += 'ตู้ล่างมีสองราคาค่ะ (ระยะรวม ' + belowWidth + ' เมตร)';
        }
    ...
    result += ' <br /> ';
    result += ' <br /> ';
    result += 'คิววันวัดหน้างาน ถ้าลูกค้าสะดวก ส่วญใหญ่แล้วไม่เกิน 1 อาทิตย์ค่ะ หลังจากวันวัดหน้างานใช้เวลาผลิต 7-10 วัน และติดตั้งใช้เวลา 1-2 วันค่ะ';
    result += ' <br /> ';
    result += ' <br /> ';
    result += 'ขอบคุณค่ะ';
